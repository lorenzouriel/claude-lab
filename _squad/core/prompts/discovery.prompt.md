...
- `_squad/_memory/company.md` — company name, tone, brand, products
- `_squad/_memory/preferences.md` — user's preferred language, tools, defaults
...
Scan the `_squad/core/best-practices/` directory at runtime. List ONLY the filenames — do NOT read or load the file contents. Ask: "Which formats interest you? Can be more than one."
