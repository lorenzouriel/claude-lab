...
Post-processing companion to the carousel skill. Once a carousel is approved, this turns the
working folder into a clean deliverable: **a `carousel.pdf` plus the slide images, nothing else.**
...
- **Target folder** — the carousel output folder (e.g. `outputs/content/<type>-<theme>-<date>/`).
  If the user doesn't name one, list the carousel folders and ask, or offer the most recent.
