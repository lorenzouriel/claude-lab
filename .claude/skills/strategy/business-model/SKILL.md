...
**Check for Previous Skill Outputs in `output/strategy/foundation-strategy/`:**
...
```
{PROJECT_DIRECTORY}/output/strategy/foundation-strategy/business-model-designer-{YYYY-MM-DD-HHMMSS}.md
```

#### If user selects Option 1:
1. Save the markdown report
2. Confirm: "✓ Report saved to: output/strategy/foundation-strategy/business-model-designer-{timestamp}.md"
3. Proceed to Step 16 (Skill Chaining)

#### If user selects Option 2:
1. Save the markdown report
2. Confirm: "✓ Text report saved to: output/strategy/foundation-strategy/business-model-designer-{timestamp}.md"
...
```
{PROJECT_DIRECTORY}/output/strategy/foundation-strategy/business-model-designer-{YYYY-MM-DD-HHMMSS}.txt
```
...
4. Save HTML to:
```
{PROJECT_DIRECTORY}/output/strategy/foundation-strategy/business-model-designer-{YYYY-MM-DD-HHMMSS}.html
```
...
💡 Features:
   ...
   File path: {PROJECT_DIRECTORY}/output/strategy/foundation-strategy/business-model-designer-{timestamp}.html
```
...
1. **Verification Checklist** (MUST READ FIRST):
   ```
   .claude/skills/strategy/html-templates/VERIFICATION-CHECKLIST.md
   ```

2. **Base Template** (shared editorial structure):
   ```
   .claude/skills/strategy/html-templates/base-template.html
   ```

3. **Skill-Specific Template** (content sections & charts):
   ```
   .claude/skills/strategy/html-templates/business-model-designer.html
   ```
