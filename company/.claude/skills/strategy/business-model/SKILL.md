...
**Check for Previous Skill Outputs in `resources/foundation-strategy/`:**
...
```
{PROJECT_DIRECTORY}/resources/foundation-strategy/business-model-designer-{YYYY-MM-DD-HHMMSS}.md
```

#### If user selects Option 1:
1. Save the markdown report
2. Confirm: "✓ Report saved to: resources/foundation-strategy/business-model-designer-{timestamp}.md"
3. Proceed to Step 16 (Skill Chaining)

#### If user selects Option 2:
1. Save the markdown report
2. Confirm: "✓ Text report saved to: resources/foundation-strategy/business-model-designer-{timestamp}.md"
...
```
{PROJECT_DIRECTORY}/resources/foundation-strategy/business-model-designer-{YYYY-MM-DD-HHMMSS}.txt
```
...
4. Save HTML to:
```
{PROJECT_DIRECTORY}/resources/foundation-strategy/business-model-designer-{YYYY-MM-DD-HHMMSS}.html
```
...
💡 Features:
   ...
   File path: {PROJECT_DIRECTORY}/resources/foundation-strategy/business-model-designer-{timestamp}.html
```
