...
1. **Read the verification checklist:**
   ```
   Read file: .claude/skills/market/html-templates/VERIFICATION-CHECKLIST.md
   ```

2. **Read the skeleton template:**
   ```
   Read file: .claude/skills/market/html-templates/feature-prioritization-framework.html
   ```
