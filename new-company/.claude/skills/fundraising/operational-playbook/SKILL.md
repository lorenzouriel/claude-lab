...
- [ ] HTML template located at `.claude/skills/fundraising/html-templates/operational-playbook-creator.html`
...
### Template Compliance
- [ ] Used skeleton template from `.claude/skills/fundraising/html-templates/operational-playbook-creator.html`
