...
## Why separate it from `output/marketing/`?

`output/marketing/` is the living history of marketing work - pieces,
campaigns, accumulated SEO.

`output/documents/` is "one-off thing generated today" - a report you send to the
