...
1. **Template Reference**: Read `.claude/skills/growth/html-templates/brand-identity-designer.html` for skill-specific CSS and content structure
2. **Base Template**: Read `.claude/skills/growth/html-templates/base-template.html` for canonical header, score banner, and footer patterns
3. **Verification Checklist**: Read `.claude/skills/growth/html-templates/VERIFICATION-CHECKLIST.md` for CSS verification requirements
...
**After generating the HTML report, verify against `.claude/skills/growth/html-templates/VERIFICATION-CHECKLIST.md`:**
